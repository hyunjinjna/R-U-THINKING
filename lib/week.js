 ...
 */
export function countSessions(startDateStr, weekdaysStr, cancellationsStr, today = new Date()) {
 ...
 */
export function getCurrentCurriculum(classData, curriculumRows, today = new Date()) {
 ...
 * 오늘 수업이 있는 반인지
 */
export function hasClassToday(classData, today = new Date()) {
...
export function getTodayName(today = new Date()) {
