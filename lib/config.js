...
export const SHEET_URLS = {
  ...
  notes: process.env.SHEET_NOTES_URL || '',
  textbooks: process.env.SHEET_TEXTBOOKS_URL || '',
};
...
export const DEMO_SETS = [
  { 세트이름: 'Easy Link 5 - 오답 복습', 링크: 'https://www.classcard.net/WrongWord/demo' },
  { 세트이름: 'Easy Link 5 - Unit 3', 링크: 'https://classcard.net/set/demo-el5-u3' },
  { 세트이름: 'Easy Link 5 - Unit 3 Workbook', 링크: 'https://classcard.net/set/demo-el5-u3-wb' },
  { 세트이름: 'Easy Link 5 - Unit 3 Sentences', 링크: 'https://classcard.net/set/demo-el5-u3-s' },
  { 세트이름: 'Easy Link 5 - Unit 2', 링크: 'https://classcard.net/set/demo-el5-u2' },
  { 세트이름: 'EFL Phonics 1 - Unit 6', 링크: 'https://classcard.net/set/demo-ph1-u6' },
];
...
export const DEMO_CURRICULUM = [
  ...
  { 레벨: 'Easy Link 5', 회차: '3회차', 진도: 'Unit 3', 클래스카드URL: 'https://classcard.net/ex/e3', 숙제범위: '', 영상URL: 'https://youtu.be/ex_e3', 개념설명숙제: 'Unit 3 main concept in English', 설명언어: '영어' },
